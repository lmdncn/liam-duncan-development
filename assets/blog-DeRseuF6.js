import{h as i}from"./index-CUsr2G87.js";import{g as r,p as h,e as d}from"./markdown-8oerI4z7.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const b=i("Clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]]),l=`---
...
`,p=(e,t)=>{const a=new Date(e.date);return new Date(t.date).getTime()-a.getTime()},w=Object.assign({"../content/blog/devs-are-dead-my-rebirth-as-an-ai-agent-manager.md":l,"../content/blog/getting-claude-code-right-best-practices-from-the-trenches.md":c,"../content/blog/how-a-year-off-rewired-my-perspective.md":u,"../content/blog/onboarding-has-changed-how-ai-tools-cut-ramp-up-time-in-half.md":m,"../content/blog/when-all-my-friends-became-developers-too.md":g}),s=Object.entries(w).map(([e,t])=>{const a=e.split("/").pop()||"",o=r(a),n=h(t,o);return n.readTime||(n.readTime=d(n.content)),n}).sort(p),k=()=>s,v=e=>s.find(t=>t.slug===e);export{b as C,v as a,k as g};
