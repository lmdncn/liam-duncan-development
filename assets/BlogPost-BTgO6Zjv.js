import{f as h,u as x,j as s,g as u,L as y,c as p,S as b}from"./index-CwqV19xX.js";import{a as w,C as v}from"./blog-D5o_mKLH.js";import{M as j,b as N}from"./markdown-components-BHDQWUOH.js";import"./markdown-Dmnd9Xcm.js";const $=e=>{const{title:t,category:a,date:r,author:c="Liam Duncan"}=e,i=85,f=(t.length>i?`${t.substring(0,i)}...`:t).split(" "),n=[];let o="";f.forEach(l=>{const m=o?`${o} ${l}`:l;m.length>45&&o?(n.push(o),o=l):o=m}),o&&n.push(o);const d=`
