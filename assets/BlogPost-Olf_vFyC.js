import{f as u,u as h,j as e,g as p,L as x,c as b,S as y,C as j,d as N,b as w,e as v}from"./index-B9U4UkYQ.js";import{a as $,C as k}from"./blog-CDEU-L-s.js";import{A as C,M as B}from"./article-layout-XGE5Fzts.js";import"./markdown-BswAPSlQ.js";const D=r=>{const{title:a,category:o,date:l,author:d="Liam Duncan"}=r,t=85,g=(a.length>t?`${a.substring(0,t)}...`:a).split(" "),i=[];let n="";g.forEach(c=>{const m=n?`${n} ${c}`:c;m.length>45&&n?(i.push(n),n=c):n=m}),n&&i.push(n);const f=`
