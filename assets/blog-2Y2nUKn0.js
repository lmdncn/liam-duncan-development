import{i as d}from"./index-Bim-sZRH.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k=d("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A=d("Clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]]),g=`---
...
`,p=e=>{const n=/^---\r?\n([\s\S]*?)\r?\n---\r?\n([\s\S]*)$/,t=e.match(n);if(!t)return{data:{},content:e};const[,a,o]=t,s={};return a.split(`
`).forEach(r=>{const i=r.indexOf(":");if(i>0){const h=r.substring(0,i).trim(),c=r.substring(i+1).trim().replace(/^["']|["']$/g,"");s[h]=c}}),{data:s,content:o}},f=(e,n)=>{const{data:t,content:a}=p(e);return{slug:n,title:t.title||"Untitled",date:t.date||"No date",excerpt:t.excerpt||"",category:t.category||"Uncategorized",readTime:t.readTime,order:t.order?parseInt(t.order,10):void 0,content:a}},y=e=>{const t=e.trim().split(/\s+/).length;return`${Math.ceil(t/200)} min read`},w=e=>e.replace(/\.md$/,""),b=(e,n)=>e.order!==void 0&&n.order!==void 0?n.order-e.order:e.order!==void 0&&n.order===void 0?-1:e.order===void 0&&n.order!==void 0?1:0,v=Object.assign({"../content/blog/devs-are-dead-my-rebirth-as-an-ai-agent-manager.md":g,"../content/blog/how-a-year-off-rewired-my-perspective.md":u,"../content/blog/when-all-my-friends-became-developers-too.md":m}),l=Object.entries(v).map(([e,n])=>{const t=e.split("/").pop()||"",a=w(t),o=f(n,a);return o.readTime||(o.readTime=y(o.content)),o}).sort(b),T=()=>l,x=e=>l.find(n=>n.slug===e);export{k as A,A as C,x as a,T as g};
