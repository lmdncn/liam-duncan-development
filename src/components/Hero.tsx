...
import { Download, MapPin, ArrowRight, Linkedin } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-32 right-16 w-24 h-24 bg-accent/10 rounded-full blur-lg animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-primary/8 rotate-45 blur-lg animate-pulse" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="text-center text-primary-foreground">
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <p className="text-lg md:text-xl mb-12 max-w-3xl mx-auto leading-relaxed opacity-90 font-medium">
              I build scalable systems that help teams accelerate, scale, and harness AI.
            </p>
          </div>
